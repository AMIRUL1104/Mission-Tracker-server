...
export class StreakService {
  ...
  static async getStreakStats(userId: string, monthKey?: string) {
    ...
    while (true) {
      const formatted = checkDate.toISOString().split("T")[0] as string;
  ...
  // // ৩. ইউজারের সব স্ট্রিক মুছে ফেলা
  // static async resetStreaks(userId: string) {
  //   return await prisma.streak.deleteMany({
  //     where: { userId },
  //   });
  // }
