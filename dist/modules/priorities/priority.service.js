...
export class PriorityService {
    ...
    static async getPrioritiesByMonth(userId, monthId) {
    ...
    static async createPriority(userId, data) {
    ...
    static async updatePriority(userId, priorityId, data) {
    ...
    static async deletePriority(userId, priorityId) {
    ...
    // ---------------- MILESTONE LOGIC ----------------
    // ৫. Milestone যোগ করা
    static async addMilestone(userId, priorityId, title) {
        // Ownership check
    ...
    static async toggleMilestone(userId, milestoneId, completed) {
    ...
    static async deleteMilestone(userId, milestoneId) {
        const milestone = await prisma.milestone.findFirst({
            where: { id: milestoneId, priority: { month: { userId } } },
        });
        if (!milestone)
    ...
    static async recalculateProgress(priorityId) {
